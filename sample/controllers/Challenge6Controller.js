//This jquery library formats and parses the numbers 
...
define(['angularAMD'], function (angularAMD) {
  'use strict';
  angularAMD.controller('Challenge6Controller', function ($scope) {
        $scope.title = "Challenge 6";
        $scope.description = `Have a directive that is dependent of ngModel, that restricts the input to numbers only and
    ...
    angularAMD.directive('format', [function () {
        return {
            require: '?ngModel',
